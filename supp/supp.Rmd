...
```{r lnRR_1A, echo=FALSE, include=TRUE, message=FALSE, warning=FALSE, class.source='klippy'}
...
```{r bird_1A, echo=FALSE, include=TRUE, message=FALSE, warning=FALSE, class.source='klippy'}
################################################
    # METHOD 1A
################################################

    # Fit model with new sampling variance
    method_1A_bird <- rma.mv(lnrr_laj_orig ~ 1, V = v_lnrr_laj,
...
```{r lnRR_1B, echo=FALSE, include=TRUE, message=FALSE, warning=FALSE, class.source='klippy'}
...
```{r bird_1B, echo=FALSE, include=TRUE, message=FALSE, warning=FALSE, class.source='klippy'}
################################################
    # METHOD 1B
################################################
