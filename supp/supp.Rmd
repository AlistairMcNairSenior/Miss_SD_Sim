...
More formally, we recommend that authors explicitly test whether an effect size meets normality assumptions (which in fact is good practice in any case). This can be achieved using Geary's test (proposed by @Lajeunesse2015). We then recommend that $CV^2$ be calculated with only those effect sizes that pass Geary's test. 
