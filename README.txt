...
There are 4 files containing code and one .Rdata file containing results from the simulation. In order of use the files are:

Header.R - contains 2 functions used for the simulation.

MLMA_HPC.R - code to run the simulation. Designed to run as an array (1000 instances) job on the HPC here in Sydney.
